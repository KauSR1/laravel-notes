                ...
                <div class="col-lg-10 col-xl-8">
                    ...
                    <div class="p-4 p-md-5 bg-white mb-4" style="border: 1px solid #e5e3dd;">
                        ...
                        <form action="{{ route('editNoteSubmit') }}" method="post">
                            @csrf
                            {{-- ID da nota criptografado (escondido) --}}
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control input-oriental"
                                          ...
                                          required>{{ old('text_note', $note->description) }}</textarea>
                            ...
                            <div class="d-flex justify-content-end gap-2 pt-3" style="border-top: 1px dashed #f0eee9;">
                                ...
                                {{-- Salvar alterações --}}
                                <button type="editSubmit" class="btn btn-oriental-dark py-2 px-4 text-uppercase fw-bold">
                                    <i class="fa-regular fa-circle-check me-2"></i>Save Edit
                                </button>
                            </div>
                        </form>
                    </div>
